...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddTodo = __webpack_require__(189);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_AddTodo2.default, {
	                    onAddClick: function onAddClick(text) {
	                        console.log('dispatching', (0, _action.addTodo)(text));
	                        dispatch((0, _action.addTodo)(text));
	                        console.log('next state', window.store.getState());
	                    } }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = {
	    visibilityFilter: _action.VisibilityFilters.SHOW_ALL,
	    todos: []
	};
	...
	function todos() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.todos : arguments[0];
	    var action = arguments[1];
	...
	function visibilityFilter() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState.visibilityFilter : arguments[0];
	    var action = arguments[1];
