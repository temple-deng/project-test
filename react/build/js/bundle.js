...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddSec = function (_React$Component) {
	    _inherits(AddSec, _React$Component);

	    function AddSec(props) {
	        _classCallCheck(this, AddSec);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AddSec).call(this, props));
	    ...
	    _createClass(AddSec, [{
	        ...
	        value: function handleClick() {
	            var name = this.refs.itemName.value.trim();
	            if (!name) {
	                return;
	            }
	            var now = new Date();
	            var createTime = now.toLocaleDateString().replace(/\//g, "-");
	            var status = "not start";
	            var startTime = null;
	            var endTime = null;
	            var operation = {
	                start: false,
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'add-sec' },
	                _react2.default.createElement('input', { type: 'text', ref: 'itemName', placeholder: '添加一条任务', value: this.props.itemName, onChange: this.handleChange }),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'sub-btn', onClick: this.handleClick },
	                    '添加'
	                )
	            );
	        }
	...
	var OperationBtn = function (_React$Component2) {
	    _inherits(OperationBtn, _React$Component2);

	    function OperationBtn() {
	        _classCallCheck(this, OperationBtn);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(OperationBtn).call(this));

	        _this2.handleDelete = _this2.handleDelete.bind(_this2);
	        _this2.handleStartMission = _this2.handleStartMission.bind(_this2);
	        _this2.handleFinMission = _this2.handleFinMission.bind(_this2);
	        return _this2;
	    }
	    ...
	    _createClass(OperationBtn, [{
	        key: 'handleStartMission',
	        value: function handleStartMission() {
	        ...
	        key: 'handleFinMission',
	        value: function handleFinMission() {
	            var index = this.props.index;
	        ...
	        key: 'render',
	        value: function render() {
	            var startStatus = this.props.btnStatus.start ? _react2.default.createElement(
	                'button',
	                { type: 'button', disabled: true },
	                '开始'
	            ) : _react2.default.createElement(
	                'button',
	                { type: 'button', onClick: this.handleStartMission },
	                '开始'
	            );

	            var finStatus = this.props.btnStatus.start ? this.props.btnStatus.finished ? _react2.default.createElement(
	                'button',
	                { type: 'button', disabled: true },
	                '完成'
	            ) : _react2.default.createElement(
	                'button',
	                { type: 'button', onClick: this.handleFinMission },
	                '完成'
	            ) : _react2.default.createElement(
	                'button',
	                { type: 'button', disabled: true },
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'td',
	                    null,
	                    statusObj[this.props.item.status]
	                ),
	                _react2.default.createElement(
	                    'td',
	                    null,
	                    this.props.item.startTime ? this.props.item.startTime : ''
	                ),
	                _react2.default.createElement(
	                    'td',
	                    null,
	                    this.props.item.endTime ? this.props.item.endTime : ''
	                ),
	                _react2.default.createElement(
	                    'td',
	                    null,
	                    _react2.default.createElement(OperationBtn, { btnStatus: this.props.item.operation, index: this.props.index, onItemDelete: this.props.onItemDelete,
	...
	var ListTable = function (_React$Component4) {
	    _inherits(ListTable, _React$Component4);

	    function ListTable(props) {
	        _classCallCheck(this, ListTable);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ListTable).call(this, props));
	    }
	    ...
	    _createClass(ListTable, [{
	        ...
	        value: function render() {
	            ...
	            this.props.list.forEach(function (value, index, arr) {
	                rows.push(_react2.default.createElement(ListItem, { key: value.name, item: value, index: index, onItemDelete: self.props.onItemDelete,
	...
	var ListBox = function (_React$Component5) {
	    _inherits(ListBox, _React$Component5);

	    function ListBox(props) {
	        _classCallCheck(this, ListBox);

	        var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(ListBox).call(this, props));

	        _this5.state = {
	            itemName: "",
	            list: []
	        };
	        _this5.handleInput = _this5.handleInput.bind(_this5); //用户输入任务
	        _this5.handleSubmit = _this5.handleSubmit.bind(_this5); //提交任务
	        _this5.handleItemDelete = _this5.handleItemDelete.bind(_this5); //删除任务
	        _this5.objToUrlencoded = _this5.objToUrlencoded.bind(_this5); //处理URL参数
	        _this5.handleStartMission = _this5.handleStartMission.bind(_this5); //开始任务
	        _this5.handleFinMission = _this5.handleFinMission.bind(_this5); //完成任务
	        return _this5;
	    }

	    _createClass(ListBox, [{
	        key: 'handleInput',
	        value: function handleInput(name) {
	        ...
	        value: function handleSubmit(item) {
	            ...
	            var urlStr = this.objToUrlencoded(item);
	            xhr.send(urlStr);
	        }
	        ...
	        key: 'objToUrlencoded',
	        value: function objToUrlencoded(obj) {
	            var keysArr = Object.keys(obj);
	            var self = this;
	            var urlencodedStr = '';
	            keysArr.forEach(function (value) {
	                if (_typeof(obj[value]) === 'object' && obj[value] !== null) {
	                    var subUrlencodedStr = self.objToUrlencoded(obj[value]);
	                    var subUrlencodedArr = subUrlencodedStr.split('&');
	                    subUrlencodedArr.forEach(function (val) {
	        ...
	        */
	        ...
	        value: function handleItemDelete(itemIndex) {
	            var xhr = new XMLHttpRequest();
	            var url = this.props.url;
	            xhr.open('DELETE', url);
	            xhr.onreadystatechange = function () {
	        ...
	        key: 'handleStartMission',
	        value: function handleStartMission(itemIndex) {
	            var xhr = new XMLHttpRequest();
	            var url = this.props.url;
	            xhr.open('POST', url);
	            xhr.onreadystatechange = function () {
	        ...
	        key: 'handleFinMission',
	        value: function handleFinMission(itemIndex) {
	            var xhr = new XMLHttpRequest();
	            var url = this.props.url;
	            xhr.open('POST', url);
	            xhr.onreadystatechange = function () {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { id: 'listBox' },
	                _react2.default.createElement(AddSec, { itemName: this.state.itemName, onUserInput: this.handleInput,
	                    onSubmit: this.handleSubmit
	                }),
	                _react2.default.createElement(ListTable, { list: this.state.list, onItemDelete: this.handleItemDelete,
	...
	_reactDom2.default.render(_react2.default.createElement(ListBox, { url: '/api/list' }), document.getElementById('container'));
